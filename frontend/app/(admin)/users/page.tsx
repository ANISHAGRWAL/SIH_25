...
const StudentManagementSystem = () => {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      setIsLoadingDetail(true); // Assuming you meant this instead of setIsLoading
      try {
        const token = localStorage.getItem("token") || "";
        const usersFromBackend = await getUsers(token);
  ...
  const getPHQSeverity = (score: number) => {
    ...
    if (score <= 9)
      return { level: "Mild", color: "text-yellow-600", bg: "bg-yellow-100" };
    if (score <= 14)
      return {
        level: "Moderate",
  ...
  const getParameterIcon = (parameter: string) => {
    switch (parameter.toLowerCase()) {
      case "mood disturbance":
        return <Heart className="h-4 w-4" />;
      case "sleep disruption":
        return <Moon className="h-4 w-4" />;
      case "appetite issues":
        return <Utensils className="h-4 w-4" />;
      case "academic disengagement":
        return <GraduationCap className="h-4 w-4" />;
      case "social withdrawal":
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-slate-600 mt-1">
                Detailed view of {selectedStudent.user.name}'s information and
                progress
              </p>
            </div>
          </div>
              ...
              <div className="mt-6 bg-white/90 backdrop-blur-md border border-gray-200/50 shadow-xl rounded-2xl p-6">
                ...
                {selectedStudent.user.phqs.length > 0 ? (
                      ...
                      return (
                        ...
                        >
                          <div className="flex justify-between items-center mb-2">
                            ...
                            <span
                              className={`px-3 py-1 rounded-full text-xs font-medium ${severity.bg} ${severity.color}`}
                            >
                              {severity.level}
                            </span>
                          </div>
                  ...
                  <p className="text-slate-500 text-sm">
                    No PHQ-9 assessments available
                  </p>
                )}
              </div>
            </div>
              ...
              <div className="bg-white/90 backdrop-blur-md border border-gray-200/50 shadow-xl rounded-2xl p-6">
                ...
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <ResponsiveContainer width="100%" height={300}>
                      <LineChart
                        data={selectedStudent?.journalReport?.trend || []}
                      ...
                      >
                        ...
                        <Line
                          type="monotone"
                          dataKey="academic_disengagement"
                          stroke="#f59e0b"
                          strokeWidth={2}
                          name="Academics"
                          dot={{ r: 3 }}
                ...
                <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 mt-6">
                  {selectedStudent?.journalReport?.summary?.map((item) => (
                    <div
                      key={item.parameter}
                      className="bg-gradient-to-r from-slate-50 to-gray-50 rounded-lg p-4"
                    >
                      ...
                      >
                        <div className="flex justify-between items-start mb-3">
                          ...
                          <div className="flex flex-col items-end space-y-2">
                            ...
                            <span
                              className={`flex items-center text-xs ${getUrgencyColor(
                                booking.urgency
                              )}`}
                            >
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-600 mt-1">
            Manage platform students and their access permissions
          </p>
        </div>
      </div>
      ...
      <div className="bg-white/90 backdrop-blur-md border border-gray-200/50 shadow-xl rounded-2xl p-6">
        ...
        {searchTerm && (
          <div className="text-sm text-slate-600">
            Found {filteredUsers.length} student
            ...
            <table className="w-full">
              <thead className="bg-gradient-to-r from-slate-50 to-gray-50 border-b border-gray-200">
                <tr>
                  ...
                  <th className="px-8 py-4 text-center text-xs font-semibold text-slate-600 uppercase tracking-wider">
                    Actions
                  </th>
                </tr>
              </thead>
