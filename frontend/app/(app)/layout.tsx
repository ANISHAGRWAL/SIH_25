    ...
    <div className="min-h-screen bg-blue-50 font-sans text-slate-800">
      ...
      <header className="md:hidden bg-white/90 backdrop-blur-sm border-b border-gray-200 shadow-sm sticky top-0 z-40">
        <div className="flex items-center justify-between px-4 py-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-lg font-bold text-slate-900">MindMates</span>
          </div>
      ...
      <div className="grid md:grid-cols-[280px_1fr] lg:grid-cols-[300px_1fr] gap-6 p-4 md:p-8">
        ...
        <aside className="hidden md:block bg-white/80 backdrop-blur-sm rounded-3xl p-6 border border-gray-200 shadow-xl">
          ...
          <nav className="space-y-3">
            <SideLink href="/dashboard" label="Dashboard" isActive={pathname === "/dashboard"} icon="dashboard" />
            <SideLink href="/chatbot" label="Chat Bot" isActive={pathname === "/chatbot"} icon="chat" />
            <SideLink href="/mind-log" label="Daily Mind Log" isActive={pathname === "/mind-log"} icon="journal" />
            <SideLink href="/psych-tests" label="Psych Test" isActive={pathname === "/psych-tests"} icon="test" />
            <SideLink href="/book-session" label="Book Session" isActive={pathname === "/book-session"} icon="calendar" />
            <SideLink href="/expert-support" label="Expert Support" isActive={pathname === "/expert-support"} icon="support" />
            <div className="border-t border-gray-200 my-4"></div>
            <SideLink href="/admin/analytics" label="Admin Analytics" isActive={pathname === "/admin/analytics"} icon="analytics" />
          </nav>
        </aside>
      ...
      <footer className="fixed bottom-0 left-0 right-0 z-50 md:hidden bg-white/90 backdrop-blur-md border-t border-gray-200">
        <nav className="flex items-center justify-around px-2 py-3">
          <MobileLink href="/dashboard" label="Dashboard" isActive={pathname === "/dashboard"} icon="dashboard" />
          <MobileLink href="/chatbot" label="Chat Bot" isActive={pathname === "/chatbot"} icon="chat" />
          <MobileLink href="/mind-log" label="Mind Log" isActive={pathname === "/mind-log"} icon="journal" />
          <MobileLink href="/expert-support" label="Support" isActive={pathname === "/expert-support"} icon="support" />
...
function SideLink({ href, label, isActive = false, icon }: { href: string; label: string; isActive?: boolean; icon: string }) {
...
function MobileLink({ href, label, isActive = false, icon }: { href: string; label: string; isActive?: boolean; icon: string }) {
