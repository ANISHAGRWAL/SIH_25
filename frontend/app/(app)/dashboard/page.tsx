...
// MusicPlayer Component (no changes needed inside this function)
  ...
  return (
    <div className="rounded-3xl bg-white/90 p-1 shadow-[0_10px_30px_rgba(0,0,0,0.05),0_0_20px_rgba(0,0,0,0.02)] transition-all duration-300 hover:shadow-[0_15px_40px_rgba(0,0,0,0.08),0_0_25px_rgba(0,0,0,0.04)] backdrop-blur-sm">
      <div className="rounded-[calc(1.5rem-4px)] bg-white/95 backdrop-blur-md p-6 space-y-4">
        {/* Top Row: Track Info, Main Controls, Volume - NOW RESPONSIVE */}
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 flex-wrap">
          ...
          <div className="flex items-center gap-3 justify-end w-full md:w-auto">
            ...
            <input
              ...
              className="w-24 md:w-28 h-2 bg-gray-200 rounded-full appearance-none cursor-pointer music-player-slider"
            />
        ...
        {/* Collapsible Playlist (already responsive with sm:grid-cols-2) */}
        {showPlaylist && (
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div onClick={() => (location.href = "/facial-mood-detection")} className="rounded-3xl bg-white/90 p-6 ring-1 ring-slate-200 hover:shadow-2xl hover:shadow-blue-100/50 transition-all duration-500 cursor-pointer transform hover:-translate-y-2 group animate-slideInUp bg-gradient-to-br from-white to-blue-50/30" role="button" tabIndex={0} onKeyDown={(e) => { if (e.key === "Enter" || e.key === " ") { location.href = "/facial-mood-detection"; } }}>
              <div className="flex flex-col text-center md:text-left items-center md:items-start md:flex-row gap-4 h-full">
                  ...
                  <div className="flex flex-col flex-1">
                      <div className="flex items-center justify-center md:justify-between w-full mb-2">
                          ...
                          <div className="hidden md:block transform group-hover:scale-110 transition-transform duration-300"><StatusDot status="success" /></div>
                      </div>
              ...
              <div className="flex flex-col text-center md:text-left items-center md:items-start md:flex-row gap-4 h-full">
                  ...
                  <div className="flex flex-col flex-1">
                      <div className="flex items-center justify-center md:justify-between w-full mb-2">
                          ...
                          <div className="hidden md:block transform group-hover:scale-110 transition-transform duration-300"><StatusDot status="pending" /></div>
                      </div>
