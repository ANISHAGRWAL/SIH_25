    ...
    <div className="flex flex-col h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <div className="flex items-center justify-between p-1 border-b border-gray-200/60 bg-white/80 backdrop-blur-lg relative z-10">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-800">MindMates AI</h1>
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-xl p-6 w-full max-w-sm">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600 mb-6">This will permanently delete all your messages. This action cannot be undone.</p>
          ...
          {messages.length === 0 ? (
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-4 text-center">
              <div className="max-w-md">
                ...
                <h2 className="text-xl font-bold text-gray-800 mb-2">Hello! I'm your mental health companion.</h2>
                <p className="text-gray-600 mb-6">
                  I'm here to listen and support you. Feel free to share what's on your mind - whether it's something that's bothering you, a win you'd like to celebrate, or just how your day is going.
                </p>
                <p className="text-sm text-gray-700 mb-3 font-medium">Quick responses:</p>
